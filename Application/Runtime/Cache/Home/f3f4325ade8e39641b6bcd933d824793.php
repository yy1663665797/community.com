...
<div class="layui-layout layui-layout-admin">
	...
	<body>
      ...
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">小区管理</strong><small></small></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
              <div class="am-btn-group am-btn-group-xs">
                  <a href="<?php echo U('department/update');?>" type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
              </div>
          </div>
        </div>
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <?php if(is_array($userinfo)): foreach($userinfo as $key=>$vo): ?><tr>
                ...
                <td><a href="<?php echo U('houseList',['id'=>$vo['id'],com_id=>$vo['id']]);?>"><?php echo ($vo["xiaoqu_name"]); ?></a></td>
                <td><?php echo ($vo["beizhu"]); ?></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="<?php echo U('update', ['id'=>$vo['id']]);?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>                    </div>
                  </div>
                </td>
