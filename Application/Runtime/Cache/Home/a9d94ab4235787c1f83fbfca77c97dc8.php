...
<div class="layui-layout layui-layout-admin">
	...
	<body>
      ...
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">楼栋列表</strong><small></small></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
              <div class="am-btn-group am-btn-group-xs">
                  <a href="<?php echo U('department/houseupdate',['com_id'=>I('id')]);?>" type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
              </div>
          </div>
        </div>
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                <th class="table-check"><input type="checkbox"></th>
                  ...
                  <th class="table-title">楼栋号</th>
                  <th class="table-title">备注</th>
                  <th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
              <?php if(is_array($house_list)): foreach($house_list as $key=>$vo): ?><tr>
                <td><input type="checkbox"></td>
                <td><?php echo ($vo["id"]); ?></td>
                <td><a href="<?php echo U('HomeList',['id'=>$vo['id'],'ho_id'=>$vo['id'],'com_id'=>I('com_id')]);?>"><?php echo ($vo["house_no"]); ?></a></td>
                <td><?php echo ($vo["remark"]); ?></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="<?php echo U('department/houseupdate',['com_id'=>I('id'),'id'=>$vo['id']]);?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>                    </div>
                  </div>
                </td>
