	...
	<body>
		...
		<div class="admin-content">
			<div class="admin-content-body">
				<div class="am-g">
					<form class="am-form am-form-horizontal" action="<?php echo U('Department/updateSave');?>"
						 method="post"
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-2" required placeholder=""
									name="xiaoqu_name"  data-equal-to="#doc-vld-pwd-1" value="<?php echo ($userinfo["xiaoqu_name"]); ?>" >
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-2" required placeholder=""
									   name="beizhu"  data-equal-to="#doc-vld-pwd-1" value="<?php echo ($userinfo["beizhu"]); ?>" >
							</div>
						</div>
