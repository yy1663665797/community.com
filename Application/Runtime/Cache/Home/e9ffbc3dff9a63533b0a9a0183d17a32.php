	...
	<body>
		...
		<div class="admin-content">
			<div class="admin-content-body">
				<div class="am-g">
					<form class="am-form am-form-horizontal" action="<?php echo U('Department/houseUpdateSave');?>"
						 method="post"
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-2" required placeholder=""
									name="house_no"  data-equal-to="#doc-vld-pwd-1" value="<?php echo ($house["house_no"]); ?>" >
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-name" class="am-u-sm-3 am-form-label">
							...
							<div class="am-u-sm-9">
								<input type="text" id="doc-vld-pwd-2" required placeholder=""
									   name="remark"  data-equal-to="#doc-vld-pwd-1" value="<?php echo ($house["remark"]); ?>" >
							</div>
						</div>

						<input type="hidden" name="id" value="<?php echo ($house["id"]); ?>">
						<input type="hidden" name="com_id" value="<?php echo I('com_id'); ?>">
						<div class="am-form-group">
